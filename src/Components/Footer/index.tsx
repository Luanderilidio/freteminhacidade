...
export default function Footer() {
  return (
    <div className="grid grid-cols-12 gap-10 bg-black text-white px-10 py-5  ">
      ...
      <div className="col-span-3 flex flex-col items-start justify-start gap-1">
        ...
        <button className="text-sm hover:underline">Reporte um problema</button>
      ...
      <div className="col-span-3 flex flex-col items-start justify-start gap-1">
        ...
        <button className="text-sm hover:underline">Fórum da comunidade</button>
      </div>
